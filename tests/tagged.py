...
from bw2analyzer.tagged import traverse_tagged_databases, multi_traverse_tagged_databases, get_cum_impact, get_multi_cum_impact
    ...
    Database("background").write(
        {
            ("background", "first"): {
                "exchanges": [
                    {"input": ("biosphere", "bad"), "amount": 1, "type": "biosphere"},
                    {"input": ("background", "first"), "amount": 5, "type": "production"}
                ],
            },
            ("background", "second"): {
                "exchanges": [
                    ...
                    "technosphere": [
                        {
                            "amount": 2,
                            "biosphere": [
                                {"amount": 16 / 3, "impact": 32 / 3, "tag": "C"},
                                {"amount": 14 / 3, "impact": 42 / 3, "tag": "D"},
                            ],
                            "activity": get_activity(("foreground", "ii")),
                            "technosphere": [],
                            "impact": 0,
