...
def traverse_tagged_databases(functional_unit, method, label="tag",
                              default_tag="other", secondary_tags=[]):
    ...
    graph = [recurse_tagged_database(key, amount, method_dict, lca, label, default_tag, secondary_tags)
...
def recurse_tagged_database(activity, amount, method_dict, lca, label, default_tag, secondary_tags=[]):
    ...
    return {
        ...
        'technosphere': [recurse_tagged_database(exc.input, exc['amount'] * amount,
                                                 method_dict, lca, label, default_tag, secondary_tags)
                         for exc in inside]
    }
